class Xchtmlreport < Formula
  ...
  homepage "https://github.com/feliciaamanda/XCTestHTMLReport"
  url "https://github.com/feliciaamanda/archive/2.1.0.tar.gz"
  sha256 "98bc4d97c18b7bfa46ca9fbe72df2351fa96acabe70f14ec5b4f9aeca7bc5b57"
  head "https://github.com/feliciaamanda/XCTestHTMLReport.git", :branch => "develop"
